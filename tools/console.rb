...
eugenia12 = Follower.new("Eugenia12", 15, "coding is ordering")
...
bloodoath_e = cult2.recruit_follower(eugenia12)
bloodoath_e = cult2.recruit_follower(eugenia2)
bloodoath_e = cult1.recruit_follower(eugenia9)
bloodoath_e = cult2.recruit_follower(eugenia4)
bloodoath_e = cult1.recruit_follower(eugenia5)
bloodoath_e = cult2.recruit_follower(eugenia6)
bloodoath_e = cult3.recruit_follower(eugenia7)
